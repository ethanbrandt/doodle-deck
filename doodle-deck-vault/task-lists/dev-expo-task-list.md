#### BUGS
- [x] Units sometimes do not move or attack when they should (probably an issue with selecting the unit)
- [ ] Units cannot be selected because UI card is selected
- [ ] UI cards move to wrong positions (I can't seem to recreate this one)
